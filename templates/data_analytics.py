...
# Define the path to the OneDrive folder where the CSV files are stored
one_drive_folder = "c:/Users/muthu.sakthivel/OneDrive - Perficient, Inc/demo project payroll/Payroll-Management-System-main/templates_py"

# Construct the full paths to the CSV files
csv_files = {
    'employees': os.path.join(one_drive_folder, 'employees.csv'),
    'clients': os.path.join(one_drive_folder, 'clients.csv'),
    'payroll': os.path.join(one_drive_folder, 'payroll.csv'),
    'TotalSalary': os.path.join(one_drive_folder, 'TotalSalary.csv'),
    'users': os.path.join(one_drive_folder, 'users.csv')
}
...
@data_analytics_bp.route('/api/hours_vs_payout', methods=['GET'])
...
@data_analytics_bp.route('/api/hourly_pay_distribution', methods=['GET'])
@login_required('admin')
...
@data_analytics_bp.route('/api/employees_by_position', methods=['GET'])
@login_required('admin')
...
@data_analytics_bp.route('/api/payout_by_position', methods=['GET'])
@login_required('admin')
